...
extern EIF_TYPED_VALUE F353_2631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F353_2632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F353_2633(EIF_REFERENCE);
extern EIF_TYPED_VALUE F353_2634(EIF_REFERENCE);
extern void F353_2635(EIF_REFERENCE);
extern void F353_7573(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F353_2631 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F353_2632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F353_2633 (EIF_REFERENCE Current)
{
	GTCX
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F353_2634 (EIF_REFERENCE Current)
{
	GTCX
...
void F353_2635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 352, Current, 0, 0, 2669);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(352, Current, 2669);
	RTIV(Current, RTAL);
...
void F353_7573 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 352, Current, 0, 7572);
	RTSA(dtype);
	RTME(dtype, 0);
