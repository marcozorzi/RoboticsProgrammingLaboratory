...
static const EIF_TYPE_INDEX egt_15_192 [] = {0xFF01,685,255,0xFFFF};
...
void Init192(void)
{
	...
	IDSC(desc_192 + 32, 90, 191);
	IDSC(desc_192 + 41, 36, 191);
	IDSC(desc_192 + 42, 30, 191);
	IDSC(desc_192 + 49, 186, 191);
	IDSC(desc_192 + 58, 205, 191);
	IDSC(desc_192 + 59, 343, 191);
	IDSC(desc_192 + 68, 300, 191);
	IDSC(desc_192 + 74, 281, 191);
	IDSC(desc_192 + 75, 243, 191);
