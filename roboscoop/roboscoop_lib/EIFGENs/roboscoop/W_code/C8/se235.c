...
body:;
	...
	*(EIF_REFERENCE *)(Current + RTWA(3770, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(5);
	RTDBGAA(Current, dtype, 3771, 0xF8000144, 0); /* mismatched_object */
...
#define uu4_2 uu4_2x.it_n4
	...
	RTHOOK(8);
	RTDBGAA(Current, dtype, 3767, 0xF8000152, 0); /* attributes_mapping */
	ur1 = NULL;
	ui4_1 = loc2;
	if (ui4_1< 0) {
		eraise ("non_negative_argument", EN_RT_CHECK);
...
#define ui4_5 ui4_5x.it_i4
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(45);
		RTDBGAL(Current, 14, 0xF8000152, 0, 0); /* loc14 */
		ur1 = NULL;
...
body:;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,391,0xFF01,0xFFF9,2,241,273,273,0xFF01,287,0xFFFF};
		EIF_TYPE typres0;
		static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
