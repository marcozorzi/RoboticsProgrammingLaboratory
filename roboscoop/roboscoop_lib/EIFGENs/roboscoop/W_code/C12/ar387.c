...
extern void F387_5353(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F387_5354(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F387_5355(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F387_5356(EIF_REFERENCE);
extern EIF_TYPED_VALUE F387_5357(EIF_REFERENCE);
...
void F387_5353 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 386, Current, 0, 1, 8931);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(386, Current, 8931);
	RTIV(Current, RTAL);
...
/* {ARRAYED_STACK}.put */
void F387_5354 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 386, Current, 0, 1, 8932);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(386, Current, 8932);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {ARRAYED_STACK}.force */
void F387_5355 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 386, Current, 0, 1, 8933);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(386, Current, 8933);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
void F387_5356 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 386, Current, 0, 0, 8934);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(386, Current, 8934);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F387_5357 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 386, Current, 1, 0, 8935);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(386, Current, 8935);
	RTIV(Current, RTAL);
	RTHOOK(1);
