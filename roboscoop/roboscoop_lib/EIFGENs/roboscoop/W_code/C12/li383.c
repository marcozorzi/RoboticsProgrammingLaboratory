...
extern EIF_TYPED_VALUE F383_3555(EIF_REFERENCE);
extern EIF_TYPED_VALUE F383_3556(EIF_REFERENCE);
extern void F383_3557(EIF_REFERENCE);
extern void F383_3558(EIF_REFERENCE);
extern EIF_TYPED_VALUE F383_3559(EIF_REFERENCE);
extern EIF_TYPED_VALUE F383_3560(EIF_REFERENCE);
...
EIF_TYPED_VALUE F383_3555 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 382, Current, 1, 0, 3945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(382, Current, 3945);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F383_3556 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 382, Current, 0, 0, 3946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(382, Current, 3946);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(2852, dtype));
	if (tb1) {
...
void F383_3557 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 382, Current, 0, 0, 3947);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(382, Current, 3947);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(3);
		RTDBGAA(Current, dtype, 2861, 0xF800017C, 0); /* active */
...
void F383_3558 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 382, Current, 2, 0, 3948);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(382, Current, 3948);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
EIF_TYPED_VALUE F383_3559 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F383_3560 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
