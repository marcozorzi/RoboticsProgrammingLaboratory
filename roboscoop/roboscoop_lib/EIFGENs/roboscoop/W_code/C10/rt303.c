...
#define ur1 ur1x.it_r
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 5333, 0xF80001B6, 0); /* replay_stack */
		...
		if (EIF_TEST(loc6)) {
			...
			*(EIF_BOOLEAN *)(Current + RTWA(5330, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
			...
			if ((EIF_BOOLEAN) !tb1) {
				...
				{
					static EIF_TYPE_INDEX typarr0[] = {0xFF01,324,0xFF01,0xFFF9,2,241,0xFF01,303,0xFF01,303,0xFFFF};
					EIF_TYPE typres0;
					static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
				...
				RTHOOK(26);
				{
					static EIF_TYPE_INDEX typarr0[] = {0xFF01,0xFFF9,2,241,0xFF01,301,0xFF01,324,0xFF01,0xFFF9,2,241,0xFF01,303,0xFF01,303,0xFFFF};
					EIF_TYPE typres0;
					static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
