...
extern void F328_3889(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F328_3891(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F328_3892(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F328_3896(EIF_REFERENCE);
...
void F328_3889 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 327, Current, 1, 1, 5287);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(327, Current, 5287);
	RTCC(arg1, 327, l_feature_name, 1, RTWCT(2188, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F328_3891 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 327, Current, 0, 1, 5288);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(327, Current, 5288);
...
void F328_3892 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 327, Current, 0, 1, 5289);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(327, Current, 5289);
	RTCC(arg1, 327, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F328_3896 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 327, Current, 0, 0, 5290);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(327, Current, 5290);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
