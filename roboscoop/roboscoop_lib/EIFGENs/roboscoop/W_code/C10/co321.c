...
extern EIF_TYPED_VALUE F321_2548(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F321_2551(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F321_2553(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F321_2548 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 320, Current, 0, 1, 2488);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(320, Current, 2488);
	RTCC(arg1, 320, l_feature_name, 1, RTWCT(2147, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COLLECTION}.fill */
void F321_2551 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 320, Current, 1, 1, 2489);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(320, Current, 2489);
	{
...
void F321_2553 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 320, Current, 0, 1, 2490);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(320, Current, 2490);
	RTCC(arg1, 320, l_feature_name, 1, RTWCT(2147, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
