...
extern EIF_TYPED_VALUE F767_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F767_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 766, Current, 0, 0, 3975);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(766, Current, 3975);
	RTIV(Current, RTAL);
	RTHOOK(1);
