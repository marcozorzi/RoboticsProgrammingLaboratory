...
extern void F787_3889(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F787_3891(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F787_3892(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F787_3896(EIF_REFERENCE);
...
void F787_3889 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 786, Current, 1, 1, 5331);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(786, Current, 5331);
	RTIV(Current, RTAL);
...
void F787_3891 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 786, Current, 0, 1, 5332);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(786, Current, 5332);
...
void F787_3892 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 786, Current, 0, 1, 5333);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(786, Current, 5333);
	RTCC(arg1, 786, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F787_3896 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 786, Current, 0, 0, 5334);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(786, Current, 5334);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
