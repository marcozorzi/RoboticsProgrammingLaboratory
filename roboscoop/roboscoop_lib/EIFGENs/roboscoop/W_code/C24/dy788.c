...
extern EIF_TYPED_VALUE F788_3737(EIF_REFERENCE);
extern EIF_TYPED_VALUE F788_3738(EIF_REFERENCE);
extern void F788_3744(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F788_3747(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F788_3748(EIF_REFERENCE);
extern EIF_TYPED_VALUE F788_3749(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F788_3737 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 787, Current, 0, 0, 5203);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(787, Current, 5203);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F788_3738 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 787, Current, 0, 0, 5204);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(787, Current, 5204);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	Result = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
...
/* {DYNAMIC_CHAIN}.prune */
void F788_3744 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 787, Current, 0, 1, 5205);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(787, Current, 5205);
	RTIV(Current, RTAL);
...
void F788_3747 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 787, Current, 0, 1, 5206);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(787, Current, 5206);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F788_3748 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 787, Current, 0, 0, 5207);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(787, Current, 5207);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F788_3749 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu1_1 uu1_1x.it_n1
	...
	RTEAA(l_feature_name, 787, Current, 2, 1, 5208);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(787, Current, 5208);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
