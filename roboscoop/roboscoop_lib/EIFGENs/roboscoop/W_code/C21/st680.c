...
extern void F680_2624(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F680_2625(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {STACK}.replace */
void F680_2624 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 679, Current, 0, 1, 2631);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(679, Current, 2631);
	RTIV(Current, RTAL);
...
/* {STACK}.fill */
void F680_2625 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 679, Current, 1, 1, 2632);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(679, Current, 2632);
	{
