...
extern void F682_5353(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F682_5354(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F682_5355(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F682_5356(EIF_REFERENCE);
extern EIF_TYPED_VALUE F682_5357(EIF_REFERENCE);
...
void F682_5353 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 681, Current, 0, 1, 8941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8941);
	RTIV(Current, RTAL);
...
/* {ARRAYED_STACK}.put */
void F682_5354 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 681, Current, 0, 1, 8942);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8942);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
/* {ARRAYED_STACK}.force */
void F682_5355 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 681, Current, 0, 1, 8943);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8943);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("extendible", EX_PRE);
...
void F682_5356 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 681, Current, 0, 0, 8944);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8944);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
EIF_TYPED_VALUE F682_5357 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 681, Current, 1, 0, 8945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(681, Current, 8945);
	RTIV(Current, RTAL);
	RTHOOK(1);
