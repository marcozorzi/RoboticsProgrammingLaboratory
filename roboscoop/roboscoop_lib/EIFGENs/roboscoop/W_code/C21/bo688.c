...
extern void F688_7571(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F688_2628 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 687, Current, 0, 0, 2652);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(687, Current, 2652);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F688_7571 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 687, Current, 0, 7570);
	RTSA(dtype);
	RTME(dtype, 0);
