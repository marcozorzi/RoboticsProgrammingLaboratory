...
extern EIF_TYPED_VALUE F804_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F804_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 803, Current, 0, 0, 3976);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(803, Current, 3976);
	RTIV(Current, RTAL);
	RTHOOK(1);
