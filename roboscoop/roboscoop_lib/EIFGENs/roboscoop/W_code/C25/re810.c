...
extern EIF_TYPED_VALUE F810_2631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F810_2632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F810_2633(EIF_REFERENCE);
extern EIF_TYPED_VALUE F810_2634(EIF_REFERENCE);
extern void F810_2635(EIF_REFERENCE);
extern void F810_7573(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F810_2631 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F810_2632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F810_2633 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 809, Current, 0, 0, 2739);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(809, Current, 2739);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F810_2634 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 809, Current, 0, 0, 2740);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(809, Current, 2740);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F810_2635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 809, Current, 0, 0, 2735);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(809, Current, 2735);
	RTIV(Current, RTAL);
...
void F810_7573 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 809, Current, 0, 7572);
	RTSA(dtype);
	RTME(dtype, 0);
