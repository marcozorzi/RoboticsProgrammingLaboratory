...
#define up1 up1x.it_p
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1476, 0xF8000144, 0); /* visited_objects */
	*(EIF_REFERENCE *)(Current + RTWA(1476, dtype)) = (EIF_REFERENCE) NULL;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 1477, 0xF8000183, 0); /* visited_types */
...
#define ui4_2 ui4_2x.it_i4
	...
	RTHOOK(7);
	RTDBGAL(Current, 7, 0xF80001B4, 0, 0); /* loc7 */
	...
	loc2 = (EIF_INTEGER_32) ti4_1;
	RTHOOK(120);
	RTDBGAL(Current, 12, 0xF8000152, 0, 0); /* loc12 */
