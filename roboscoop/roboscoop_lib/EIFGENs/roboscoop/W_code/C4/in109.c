...
#define ui4_4 ui4_4x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1545, 0xF80001C1, 0); /* integer_overflow_state1 */
	...
	*(EIF_REFERENCE *)(Current + RTWA(1545, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTHOOK(3);
	RTDBGAA(Current, dtype, 1546, 0xF80001C1, 0); /* integer_overflow_state2 */
	...
	*(EIF_REFERENCE *)(Current + RTWA(1546, dtype)) = (EIF_REFERENCE) tr1;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2880, "extend", tr1))(tr1, uu8_1x);
	RTHOOK(21);
	RTDBGAA(Current, dtype, 1547, 0xF80001C1, 0); /* natural_overflow_state1 */
	...
	*(EIF_REFERENCE *)(Current + RTWA(1547, dtype)) = (EIF_REFERENCE) tr1;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(2880, "extend", tr1))(tr1, uu8_1x);
	RTHOOK(23);
	RTDBGAA(Current, dtype, 1548, 0xF80001C1, 0); /* natural_overflow_state2 */
