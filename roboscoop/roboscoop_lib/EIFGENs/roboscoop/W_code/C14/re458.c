...
extern EIF_TYPED_VALUE F458_2631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F458_2632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F458_2633(EIF_REFERENCE);
extern EIF_TYPED_VALUE F458_2634(EIF_REFERENCE);
extern void F458_2635(EIF_REFERENCE);
extern void F458_7573(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F458_2631 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F458_2632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F458_2633 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 457, Current, 0, 0, 2685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(457, Current, 2685);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F458_2634 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 457, Current, 0, 0, 2686);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(457, Current, 2686);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F458_2635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 457, Current, 0, 0, 2681);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(457, Current, 2681);
	RTIV(Current, RTAL);
...
void F458_7573 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 457, Current, 0, 7572);
	RTSA(dtype);
	RTME(dtype, 0);
