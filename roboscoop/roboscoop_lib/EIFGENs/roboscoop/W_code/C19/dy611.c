...
extern void F611_3889(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F611_3891(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F611_3892(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F611_3896(EIF_REFERENCE);
...
void F611_3889 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 610, Current, 1, 1, 5315);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(610, Current, 5315);
	RTIV(Current, RTAL);
...
void F611_3891 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 610, Current, 0, 1, 5316);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(610, Current, 5316);
...
void F611_3892 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 610, Current, 0, 1, 5317);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(610, Current, 5317);
	RTCC(arg1, 610, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F611_3896 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 610, Current, 0, 0, 5318);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(610, Current, 5318);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
