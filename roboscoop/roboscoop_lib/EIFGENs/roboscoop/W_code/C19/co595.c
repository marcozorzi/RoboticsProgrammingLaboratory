...
extern EIF_TYPED_VALUE F595_2540(EIF_REFERENCE);
extern EIF_TYPED_VALUE F595_2541(EIF_REFERENCE);
extern EIF_TYPED_VALUE F595_2542(EIF_REFERENCE);
extern void F595_2543(EIF_REFERENCE);
extern void F595_2544(EIF_REFERENCE);
...
/* {CONTAINER}.empty */
EIF_TYPED_VALUE F595_2540 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 594, Current, 0, 0, 2451);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(594, Current, 2451);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F595_2541 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F595_2542 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 594, Current, 0, 0, 2448);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(594, Current, 2448);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
void F595_2543 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 594, Current, 0, 0, 2449);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(594, Current, 2449);
	RTIV(Current, RTAL);
...
void F595_2544 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 594, Current, 0, 0, 2450);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(594, Current, 2450);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("changeable_comparison_criterion", EX_PRE);
