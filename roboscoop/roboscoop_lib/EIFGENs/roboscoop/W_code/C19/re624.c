...
extern EIF_TYPED_VALUE F624_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F624_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 623, Current, 0, 0, 3971);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(623, Current, 3971);
	RTIV(Current, RTAL);
	RTHOOK(1);
