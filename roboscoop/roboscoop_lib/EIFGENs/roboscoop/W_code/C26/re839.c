...
extern EIF_TYPED_VALUE F839_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F839_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 838, Current, 0, 0, 3977);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(838, Current, 3977);
	RTIV(Current, RTAL);
	RTHOOK(1);
