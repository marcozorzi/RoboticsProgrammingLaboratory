...
extern EIF_TYPED_VALUE F562_2631(EIF_REFERENCE);
extern EIF_TYPED_VALUE F562_2632(EIF_REFERENCE);
extern EIF_TYPED_VALUE F562_2633(EIF_REFERENCE);
extern EIF_TYPED_VALUE F562_2634(EIF_REFERENCE);
extern void F562_2635(EIF_REFERENCE);
extern void F562_7573(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F562_2631 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F562_2632 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F562_2633 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 561, Current, 0, 0, 2703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(561, Current, 2703);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {RESIZABLE}.resizable */
EIF_TYPED_VALUE F562_2634 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 561, Current, 0, 0, 2704);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(561, Current, 2704);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F562_2635 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 561, Current, 0, 0, 2699);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(561, Current, 2699);
	RTIV(Current, RTAL);
...
void F562_7573 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 561, Current, 0, 7572);
	RTSA(dtype);
	RTME(dtype, 0);
