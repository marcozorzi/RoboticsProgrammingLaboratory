...
extern EIF_TYPED_VALUE F569_2548(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F569_2551(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F569_2553(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F569_2548 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 568, Current, 0, 1, 2506);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(568, Current, 2506);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {COLLECTION}.fill */
void F569_2551 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 568, Current, 1, 1, 2507);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(568, Current, 2507);
	{
...
void F569_2553 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 568, Current, 0, 1, 2508);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(568, Current, 2508);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
