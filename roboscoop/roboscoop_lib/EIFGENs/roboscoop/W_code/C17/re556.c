...
extern EIF_TYPED_VALUE F556_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F556_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 555, Current, 0, 0, 3969);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(555, Current, 3969);
	RTIV(Current, RTAL);
	RTHOOK(1);
