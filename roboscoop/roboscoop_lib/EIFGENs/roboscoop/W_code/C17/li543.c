...
extern EIF_TYPED_VALUE F543_3752(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F543_3753(EIF_REFERENCE);
extern EIF_TYPED_VALUE F543_3754(EIF_REFERENCE);
extern void F543_7594(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F543_3752 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 542, Current, 2, 1, 5247);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(542, Current, 5247);
...
/* {LIST}.after */
EIF_TYPED_VALUE F543_3753 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 542, Current, 0, 0, 5248);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(542, Current, 5248);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F543_3754 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 542, Current, 0, 0, 5249);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(542, Current, 5249);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F543_7594 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 542, Current, 0, 7593);
	RTSA(dtype);
	RTME(dtype, 0);
