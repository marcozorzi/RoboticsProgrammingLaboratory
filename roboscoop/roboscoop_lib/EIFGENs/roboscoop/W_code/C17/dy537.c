...
extern void F537_3889(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F537_3891(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F537_3892(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F537_3896(EIF_REFERENCE);
...
void F537_3889 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 536, Current, 1, 1, 5307);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(536, Current, 5307);
	RTIV(Current, RTAL);
...
void F537_3891 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 536, Current, 0, 1, 5308);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(536, Current, 5308);
...
void F537_3892 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 536, Current, 0, 1, 5309);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(536, Current, 5309);
	RTCC(arg1, 536, l_feature_name, 1, eif_new_type(Dftype(Current), 1), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F537_3896 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 536, Current, 0, 0, 5310);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(536, Current, 5310);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
