...
extern EIF_TYPED_VALUE F736_3568(EIF_REFERENCE);
...
EIF_TYPED_VALUE F736_3568 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 735, Current, 0, 0, 3974);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(735, Current, 3974);
	RTIV(Current, RTAL);
	RTHOOK(1);
