...
extern EIF_TYPED_VALUE F887_3752(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F887_3753(EIF_REFERENCE);
extern EIF_TYPED_VALUE F887_3754(EIF_REFERENCE);
extern void F887_7594(EIF_REFERENCE, int);
...
/* {LIST}.is_equal */
EIF_TYPED_VALUE F887_3752 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 886, Current, 2, 1, 5283);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(886, Current, 5283);
...
/* {LIST}.after */
EIF_TYPED_VALUE F887_3753 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 886, Current, 0, 0, 5284);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(886, Current, 5284);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}.before */
EIF_TYPED_VALUE F887_3754 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 886, Current, 0, 0, 5285);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(886, Current, 5285);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {LIST}._invariant */
void F887_7594 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 886, Current, 0, 7593);
	RTSA(dtype);
	RTME(dtype, 0);
