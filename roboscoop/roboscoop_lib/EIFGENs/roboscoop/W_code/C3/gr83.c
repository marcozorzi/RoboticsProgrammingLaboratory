...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(1288, dtype)) = (EIF_INTEGER_32) arg3;
	RTHOOK(13);
	RTDBGAA(Current, dtype, 1279, 0xF8000151, 0); /* nodes */
	{
	...
	*(EIF_REFERENCE *)(Current + RTWA(1279, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(14);
	RTDBGAA(Current, dtype, 1292, 0xF8000144, 0); /* grid */
	...
	*(EIF_REFERENCE *)(Current + RTWA(1292, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	for (;;) {
		...
		RTHOOK(24);
		RTDBGAL(Current, 11, 0xF8000144, 0, 0); /* loc11 */
		{
			static EIF_TYPE_INDEX typarr0[] = {0xFF01,324,0xFF01,324,0xFF01,239,0xFFFF};
			EIF_TYPE typres0;
			static EIF_TYPE typcache0 = {INVALID_DTYPE, 0};
